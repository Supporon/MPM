...
def test_evaluate_classifier_computes_mpm_metrics_when_unit_area_provided():
    load_builtin_components()
    ...
    assert "prediction_rate_auc" not in result_no_area
...
if __name__ == "__main__":
    ...
    test_evaluate_classifier_computes_mpm_metrics_when_unit_area_provided()
